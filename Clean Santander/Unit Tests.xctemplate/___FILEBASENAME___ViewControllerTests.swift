...
class ___VARIABLE_sceneName___ViewControllerTests: XCTestCase
{
    ...
    func testDisplaySomething() {
        // Given
        let viewObject = ___VARIABLE_sceneName___.Something.ViewObject()
        
        // When
        loadView()
        sut.displaySomething(viewObject: viewObject)
        
        // Then
        //XCTAssertEqual(sut.nameTextField.text, "", "displaySomething(viewObject:) should update the name text field")
    }
}
